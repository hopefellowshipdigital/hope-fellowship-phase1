    ...
    <section className="py-16 sm:py-20" aria-labelledby="latest-message-heading">
      <PageContainer>
        ...
        <div className="mt-8 grid gap-8 rounded-[var(--radius-lg)] border border-border bg-surface p-5 shadow-sm sm:p-6 lg:grid-cols-2 lg:items-center lg:gap-10">
          <PlaceholderImage
            label={featuredSermon ? featuredSermon.thumbnailLabel : "Watch our latest message"}
            aspect="video"
          />
          {featuredSermon ? (
            <div>
            ...
            <div>
              <h3 className="text-2xl font-bold text-text">Latest Message</h3>
              <p className="mt-2 text-sm text-muted-text">
                Watch the most recent message from Hope Fellowship, or visit our YouTube channel
                for more.
              </p>
              <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                <SecondaryButton
